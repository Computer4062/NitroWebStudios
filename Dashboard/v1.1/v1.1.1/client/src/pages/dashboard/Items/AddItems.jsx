...
function AddItems() {
	...
	const handleFileChange = (e) => {
		...
		setVehicleImages([...vehicleImages, ...newImages].slice(0, 10)); // Example limit of 10
	...
	const handleAddVehicle = async (e, isDraft = true) => {
		...
		// 2. Append all images from the array
		vehicleImages.forEach((imgObj) => {
			formData.append('images', imgObj.file); // Append the actual File object
		});

		// 3. Send the request to the server
		try {
			const response = await fetch("http://localhost:3000/api/vehicles/admin/addnew", {
				method: 'POST',
					...
					<div className="row g-3 mb-4">
						...
						<div className="col-md-4">
							...
							<div className="input-group">
								...
								<input type="number" className="form-control" value={vehicleData.mileage} 
						...
						<div className="col-md-6 d-flex align-items-end pb-2">
							<div className="form-check form-switch me-4">
								<input className="form-check-input" type="checkbox" id="electricSwitch" 
									...
									onChange={(e) => setVehicleData({...vehicleData, _electric: e.target.checked})} />
