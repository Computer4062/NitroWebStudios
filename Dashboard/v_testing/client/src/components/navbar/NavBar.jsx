      ...
      <div className="collapse navbar-collapse" id="navContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4 text-center">
          <li className="nav-item">
            <a href="/" className="nav-link px-3 text-white">Home</a>
          </li>
          <li className="nav-item">
            <a href="/inventory" className="nav-link px-3 text-white">Inventory</a>
          </li>
          <li className="nav-item">
            <a href="/team" className="nav-link px-3 text-white">Our Team</a>
          </li>
          <li className="nav-item">
            <a href="/contact" className="nav-link px-3 text-white">Contact Us</a>
          </li>
        </ul>
