...
function Details() {
	...
	useEffect(() => {
    fetch(`http://localhost:3000/api/stocks/find/${id}`)
	...
	useEffect(() => {
    fetch(`http://localhost:3000/api/stocks/find/type/${vehicle.vehicle_type}`)
      .then((response) => response.json())
      .then((data) => {
	...
	{vehicle.map((car) => (
		<div className="container">
			...
			<div className="mb-5">
				...
				<p className="text-secondary small fw-bold mt-1">STOCK ID: {car.id}</p>
